...
Copy-Item ".\setup_output\SteamRouteFixer_Setup_v1.0.0.exe" ".\release_artifacts\" -Force -ErrorAction SilentlyContinue
Copy-Item ".\publish_portable\SteamRouteFixer.exe" ".\release_artifacts\SteamRouteFixer_Portable_v1.0.0.exe" -Force -ErrorAction SilentlyContinue
